...
def main():
    region_name_to_scan = {
        ...
        "SRFR_130_150_all": (0, 20),
        "SRFR_150_170_all": (0, 30),
        "SRFR_170_190_all": (0, 20),
        "SRFR_190_210_all": (0, 15),
        "SRFR_210_230_all": (0, 26),
        "SRFR_230_250_all": (0, 15),
        "SRFR_250_270_all": (0, 15),
        "SRFR_270_300_all": (0, 10),
        "SRFR_300_330_all": (0, 15),
        "SRFR_330_360_all": (0, 15),
        "SRFR_360_400_all": (0, 12),
        "SRFR_400_440_all": (0, 10),
        "SRFR_440_580_all": (0, 12),
        "SRFR_580_inf_all": (0, 23),
        # SR4L
