...
python ../../discohisto/specgz.py Likelihoods/DVPlusMuConfig/SRMET_bkgonly.json srmet_bkg.json.gz
python ../../discohisto/specgz.py Likelihoods/DVPlusMuConfig/SRMU_bkgonly.json srmu_bkg.json.gz
