...
python ../../discohist/specgz.py RegionA/BkgOnly.json a_bkg.json.gz
python ../../discohist/specgz.py RegionB/BkgOnly.json b_bkg.json.gz
python ../../discohist/specgz.py RegionC/BkgOnly.json c_bkg.json.gz
